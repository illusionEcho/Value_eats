...
# redirect
class dinerRequestHandler(BaseHandler):
    def get(self):
...
class eateryRequestHandler(BaseHandler):
    def get(self):
...
# diner register
class DinerRegHandler(BaseHandler):
...
class EateryRegHandler(BaseHandler):
    def post(self):
        # print(self.request.headers.get("Content-Type"))
        ret = {'result': 0} # success
...
class DinerUpdateHandler(BaseHandler):
    def post(self):
        ret = {'result': 0} # success
...
class EateryUpdateHandler(BaseHandler):
    def post(self):
        ret = {'result': 0} # success
...
class SearchEatery(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class DetailSearchEatery(BaseHandler):
...
class ReleaseVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class DinerBookVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class EateryCheckVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class DinerReviewVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class EateryValidVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class EateryHistoryVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class EateryCommentVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class DinerValidVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)

        diner_id = json_args.get('diner_id')
        # diner_id = self.session['user']
        print(diner_id)
        date = json_args.get('date') # time stamp
...
class DinerCheckedVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class DinerOverduedVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class DeleteRegion(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class DeleteCuisine(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class UpdateRegion(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class UpdateCuisine(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class AdminDeleteDiner(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class AdminDeleteEatery(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class Recommendation(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
...
class EateryDeletePeriodicVoucher(BaseHandler):
    def post(self):
        json_data = self.request.body
        json_args = json.loads(json_data)
